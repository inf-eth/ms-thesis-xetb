...
%\Supervisor{Dr. Rashad Ramzan}
%\CoSupervisor{Dr. Rasheed Bhatti}
\CommitteeChair{Dr. Rashad Ramzan, Supervisor}
\CommitteeMembers{Dr. Rasheed Bhatti, Co. Supervisor}
                {Dr. Affan Syed, Adviser}
%Uncomment if you have a fourth member on your committee
%\AdditionalMember{Additional Member's name}

\GradSchoolDean{Dr. Mudasser Farooq}
