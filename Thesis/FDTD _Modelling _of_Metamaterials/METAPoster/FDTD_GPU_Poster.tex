...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  FDTD algorithm is readily parallelisable and can take advantage of GPU acceleration to achieve speed--ups of 5x--50x depending on hardware setup. Metamaterial scattering problems are implemented using dispersive FDTD technique on GPU resulting in performance gain of 10x--15x compared to conventional CPU implementation.
 }
...
\begin{tikzpicture}[xscale=0.55,yscale=0.55,font=\tiny]
	...
	\coordinate [label=right:\textsf{Plane Wave}] (PlaneWave) at (\MidX+0.5cm,\PMLw+0.8cm);
\end{tikzpicture}
\vspace{1em}DNG slab and cylindrical cloak problem geometries.\vspace{-2em}
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  {
%\smaller\centering
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{tikzpicture}[xscale=0.85,yscale=0.85,font=\small]
		...
		\begin{tikzpicture}[remember picture, overlay,shift={(-3.5cm,8.25cm)},xscale=0.4,yscale=0.4,font=\tiny]
					\filldraw[color=white] (-2cm,-1cm)rectangle(11.25cm,11.5cm);
					\DrawAxes{size}{time~(sec)}
						\GridOn
						\TicksOn
