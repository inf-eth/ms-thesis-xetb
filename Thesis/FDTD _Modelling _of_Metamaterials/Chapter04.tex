...
\end{table}
\subsection{Spatial Performance Analysis\index{performance analysis!spatial}}
...
\end{table}
\subsubsection{1D Simulations\index{performance analysis!spatial!1D}}
\begin{figure}[H]
\centering
\begin{tikzpicture}[font=\small]
...
\subsubsection{2D Simulations\index{performance analysis!spatial!2D}}
\begin{figure}[H]
\centering
\begin{tikzpicture}[font=\small]
	\DrawAxes{size}{time~(sec)}
...
\end{figure}
\newpage
\subsection{Temporal Performance Analysis\index{performance analysis!temporal}}
...
\end{table}
\subsubsection{1D Simulations\index{performance analysis!temporal!1D}}
\begin{figure}[H]
\centering
\begin{tikzpicture}[font=\small]
...
\end{figure}
\subsubsection{2D Simulations\index{performance analysis!temporal!2D}}
\begin{figure}[H]
\centering
\begin{tikzpicture}[font=\small]
	\DrawAxes{steps}{time~(sec)}
	\GridOn
	\TicksOn
	\XAxisText{0.05cm/25}{1cm/500}{2cm/1000}{3cm/1500}{4cm/2000}{5cm/2500}{6cm/3000}{7cm/3500}{8cm/4000}
	\XAxisText{9cm/4500}{10cm/5000}{}{}{}{}{}{}{}
	...
	\DrawLegend
\end{tikzpicture}
\caption{2D Temporal: General performance comparison}
\label{fig:Performance-2D-time}
\end{figure}
\begin{figure}[H]
\centering
\begin{tikzpicture}[font=\small]
	...
	\GridOn
	\TicksOn
	\XAxisText{0.5cm/25}{ 1cm/50}{ 2cm/100}{ 4cm/200}{ 6cm/300}{ 8cm/400}{10cm/500}{}{}
	\YAxisText{0.00cm/0.0}{1.00cm/12.5}{2.00cm/25.0}{3.00cm/37.5}{4.00cm/50.0}{5.00cm/62.5}{6.00cm/75.0}{7.00cm/87.5}{8.00cm/100.0}
	\YAxisText{9.00cm/112.5}{10.00cm/125.0}{}{}{}{}{}{}{}
	% ------- 2D temporal shorter simulations -------
	\draw[line width=1.2pt,color=red!40!yellow] (0.5cm,0.6cm) -- ( 1cm,1.1cm) -- ( 2cm,2.1cm) -- ( 4cm,4.2cm) -- ( 6cm,6.3cm) -- ( 8cm,8.4cm);
	\draw[line width=1.2pt,color=red!10!yellow] (0.5cm,1.2cm) -- ( 1cm,2.4cm) -- ( 2cm,4.6cm) -- ( 4cm, 9cm);
	\draw[line width=1.2pt,color=blue] (0.5cm, 1cm) -- ( 1cm,1.7cm) -- ( 2cm,3.4cm) -- ( 4cm,6.6cm) -- ( 6cm,9.9cm);
	\draw[line width=1.2pt,color=blue!30!white] (0.5cm,1.1cm) -- ( 1cm,2.1cm) -- ( 2cm,4.1cm) -- ( 4cm,8.2cm);
	\draw[line width=1.2pt,color=gray!70!white] (0.5cm,0.32cm) -- ( 1cm,0.23cm) -- ( 2cm,0.36cm) -- ( 4cm,0.58cm) -- ( 6cm,0.84cm) -- ( 8cm,1.2cm) -- (10cm,1.3cm);
	\draw[line width=1.2pt,color=pink] (0.5cm,0.22cm) -- ( 1cm,0.25cm) -- ( 2cm,0.37cm) -- ( 4cm,0.63cm) -- ( 6cm,0.89cm) -- ( 8cm,1.1cm) -- (10cm,1.4cm);
	\draw[line width=1.2pt,color=red!70!black] (0.5cm,0.068cm) -- ( 1cm,0.057cm) -- ( 2cm,0.064cm) -- ( 4cm,0.082cm) -- ( 6cm,0.1cm) -- ( 8cm,0.12cm) -- (10cm,0.14cm);
	\draw[line width=1.2pt,color=red] (0.5cm,0.15cm) -- ( 1cm,0.093cm) -- ( 2cm,0.1cm) -- ( 4cm,0.12cm) -- ( 6cm,0.14cm) -- ( 8cm,0.16cm) -- (10cm,0.19cm);
	\draw[line width=1.2pt,color=green!50!black] (0.5cm,0.065cm) -- ( 1cm,0.058cm) -- ( 2cm,0.068cm) -- ( 4cm,0.088cm) -- ( 6cm,0.11cm) -- ( 8cm,0.13cm) -- (10cm,0.15cm);
	\draw[line width=1.2pt,color=green] (0.5cm,0.1cm) -- ( 1cm,0.081cm) -- ( 2cm,0.092cm) -- ( 4cm,0.11cm) -- ( 6cm,0.13cm) -- ( 8cm,0.16cm) -- (10cm,0.18cm);
	\DrawLegend
\end{tikzpicture}
\caption{2D Temporal: Performance for shorter simulations}
\label{fig:Performance-shorter-times-2D-time}
\end{figure}
\begin{figure}[H]
\centering
\begin{tikzpicture}[font=\small]
	...
	\XAxisText{0.05cm/25}{1cm/500}{2cm/1000}{3cm/1500}{4cm/2000}{5cm/2500}{6cm/3000}{7cm/3500}{8cm/4000}
	\XAxisText{9cm/4500}{10cm/5000}{}{}{}{}{}{}{}
	\YAxisText{0.00cm/0.0}{1.00cm/16.5}{2.00cm/33.0}{3.00cm/49.5}{4.00cm/66.0}{5.00cm/82.5}{6.00cm/99.0}{7.00cm/115.5}{8.00cm/132.0}
	\YAxisText{9.00cm/148.5}{10.00cm/165.0}{}{}{}{}{}{}{}
	% ------- 2D temporal comparison wrt OpenCL emulated -------
	\draw[line width=1.2pt,color=red!40!yellow] (0.05cm,0.46cm) -- (0.1cm,0.8cm) -- (0.2cm,1.6cm) -- (0.4cm,3.2cm) -- (0.6cm,4.7cm) -- (0.8cm,6.4cm) -- ( 1cm,8.2cm);
	\draw[line width=1.2pt,color=red!10!yellow] (0.05cm,0.88cm) -- (0.1cm,1.8cm) -- (0.2cm,3.5cm) -- (0.4cm,6.8cm);
	\draw[line width=1.2pt,color=blue] (0.05cm,0.77cm) -- (0.1cm,1.3cm) -- (0.2cm,2.5cm) -- (0.4cm, 5cm) -- (0.6cm,7.5cm);
	\draw[line width=1.2pt,color=blue!30!white] (0.05cm,0.81cm) -- (0.1cm,1.6cm) -- (0.2cm,3.1cm) -- (0.4cm,6.2cm) -- (0.6cm,9.3cm);
	\draw[line width=1.2pt,color=gray!70!white] (0.05cm,0.24cm) -- (0.1cm,0.17cm) -- (0.2cm,0.28cm) -- (0.4cm,0.44cm) -- (0.6cm,0.64cm) -- (0.8cm,0.9cm) -- ( 1cm, 1cm) -- (1.5cm,1.5cm) -- ( 2cm,1.9cm) -- ( 3cm,2.8cm) -- ( 4cm,3.7cm) -- ( 5cm,4.6cm) -- ( 6cm,5.4cm) -- ( 7cm,7.8cm) -- ( 8cm,8.3cm) -- ( 9cm,8.3cm) -- (10cm, 9cm);
	\draw[line width=1.2pt,color=pink] (0.05cm,0.17cm) -- (0.1cm,0.19cm) -- (0.2cm,0.28cm) -- (0.4cm,0.48cm) -- (0.6cm,0.67cm) -- (0.8cm,0.87cm) -- ( 1cm,1.1cm) -- (1.5cm,1.6cm) -- ( 2cm, 2cm) -- ( 3cm, 3cm) -- ( 4cm, 4cm) -- ( 5cm, 5cm) -- ( 6cm, 6cm) -- ( 7cm, 7cm) -- ( 8cm, 8cm) -- ( 9cm,8.9cm) -- (10cm,9.9cm);
	\draw[line width=1.2pt,color=red!70!black] (0.05cm,0.052cm) -- (0.1cm,0.043cm) -- (0.2cm,0.049cm) -- (0.4cm,0.062cm) -- (0.6cm,0.077cm) -- (0.8cm,0.091cm) -- ( 1cm,0.1cm) -- (1.5cm,0.14cm) -- ( 2cm,0.17cm) -- ( 3cm,0.25cm) -- ( 4cm,0.31cm) -- ( 5cm,0.38cm) -- ( 6cm,0.45cm) -- ( 7cm,0.52cm) -- ( 8cm,0.59cm) -- ( 9cm,0.66cm) -- (10cm,0.73cm);
	\draw[line width=1.2pt,color=red] (0.05cm,0.11cm) -- (0.1cm,0.07cm) -- (0.2cm,0.076cm) -- (0.4cm,0.092cm) -- (0.6cm,0.11cm) -- (0.8cm,0.12cm) -- ( 1cm,0.14cm) -- (1.5cm,0.18cm) -- ( 2cm,0.22cm) -- ( 3cm,0.3cm) -- ( 4cm,0.38cm) -- ( 5cm,0.45cm) -- ( 6cm,0.53cm) -- ( 7cm,0.61cm) -- ( 8cm,0.68cm) -- ( 9cm,0.76cm) -- (10cm,0.84cm);
	\draw[line width=1.2pt,color=green!50!black] (0.05cm,0.049cm) -- (0.1cm,0.044cm) -- (0.2cm,0.052cm) -- (0.4cm,0.067cm) -- (0.6cm,0.082cm) -- (0.8cm,0.097cm) -- ( 1cm,0.11cm) -- (1.5cm,0.15cm) -- ( 2cm,0.19cm) -- ( 3cm,0.26cm) -- ( 4cm,0.34cm) -- ( 5cm,0.41cm) -- ( 6cm,0.49cm) -- ( 7cm,0.57cm) -- ( 8cm,0.64cm) -- ( 9cm,0.72cm) -- (10cm,0.79cm);
	\draw[line width=1.2pt,color=green] (0.05cm,0.077cm) -- (0.1cm,0.061cm) -- (0.2cm,0.069cm) -- (0.4cm,0.086cm) -- (0.6cm,0.1cm) -- (0.8cm,0.12cm) -- ( 1cm,0.13cm) -- (1.5cm,0.17cm) -- ( 2cm,0.21cm) -- ( 3cm,0.3cm) -- ( 4cm,0.38cm) -- ( 5cm,0.46cm) -- ( 6cm,0.54cm) -- ( 7cm,0.62cm) -- ( 8cm,0.7cm) -- ( 9cm,0.78cm) -- (10cm,0.86cm);
	\DrawLegend
\end{tikzpicture}
\caption{2D Temporal: Performance comparison with respect to OpenCL emulation}
\label{fig:Performance-wrtOpenCLemu-2D-time}
\end{figure}
\begin{figure}[H]
\centering
\begin{tikzpicture}[font=\small]
	...
	\draw[line width=1.2pt,color=red!40!yellow] (0.05cm, 5cm) -- (0.1cm,8.8cm);
	\draw[line width=1.2pt,color=red!10!yellow] (0.05cm,9.7cm);
	\draw[line width=1.2pt,color=blue] (0.05cm,8.5cm);
	\draw[line width=1.2pt,color=blue!30!white] (0.05cm,8.9cm);
	\draw[line width=1.2pt,color=gray!70!white] (0.05cm,2.6cm) -- (0.1cm,1.9cm) -- (0.2cm, 3cm) -- (0.4cm,4.8cm) -- (0.6cm, 7cm) -- (0.8cm,9.9cm);
	\draw[line width=1.2pt,color=pink] (0.05cm,1.9cm) -- (0.1cm,2.1cm) -- (0.2cm,3.1cm) -- (0.4cm,5.2cm) -- (0.6cm,7.4cm) -- (0.8cm,9.6cm);
	\draw[line width=1.2pt,color=red!70!black] (0.05cm,0.57cm) -- (0.1cm,0.48cm) -- (0.2cm,0.53cm) -- (0.4cm,0.69cm) -- (0.6cm,0.84cm) -- (0.8cm, 1cm) -- ( 1cm,1.2cm) -- (1.5cm,1.5cm) -- ( 2cm,1.9cm) -- ( 3cm,2.7cm) -- ( 4cm,3.5cm) -- ( 5cm,4.2cm) -- ( 6cm, 5cm) -- ( 7cm,5.7cm) -- ( 8cm,6.5cm) -- ( 9cm,7.3cm) -- (10cm, 8cm);
	\draw[line width=1.2pt,color=red] (0.05cm,1.3cm) -- (0.1cm,0.77cm) -- (0.2cm,0.83cm) -- (0.4cm, 1cm) -- (0.6cm,1.2cm) -- (0.8cm,1.4cm) -- ( 1cm,1.6cm) -- (1.5cm, 2cm) -- ( 2cm,2.4cm) -- ( 3cm,3.3cm) -- ( 4cm,4.1cm) -- ( 5cm,4.9cm) -- ( 6cm,5.8cm) -- ( 7cm,6.7cm) -- ( 8cm,7.5cm) -- ( 9cm,8.4cm) -- (10cm,9.3cm);
	\draw[line width=1.2pt,color=green!50!black] (0.05cm,0.54cm) -- (0.1cm,0.49cm) -- (0.2cm,0.57cm) -- (0.4cm,0.73cm) -- (0.6cm,0.9cm) -- (0.8cm,1.1cm) -- ( 1cm,1.2cm) -- (1.5cm,1.6cm) -- ( 2cm,2.1cm) -- ( 3cm,2.9cm) -- ( 4cm,3.7cm) -- ( 5cm,4.6cm) -- ( 6cm,5.4cm) -- ( 7cm,6.2cm) -- ( 8cm, 7cm) -- ( 9cm,7.9cm) -- (10cm,8.7cm);
	\draw[line width=1.2pt,color=green] (0.05cm,0.84cm) -- (0.1cm,0.67cm) -- (0.2cm,0.76cm) -- (0.4cm,0.95cm) -- (0.6cm,1.1cm) -- (0.8cm,1.3cm) -- ( 1cm,1.5cm) -- (1.5cm,1.9cm) -- ( 2cm,2.4cm) -- ( 3cm,3.3cm) -- ( 4cm,4.1cm) -- ( 5cm,5.1cm) -- ( 6cm,5.9cm) -- ( 7cm,6.8cm) -- ( 8cm,7.7cm) -- ( 9cm,8.6cm) -- (10cm,9.5cm);
	\DrawLegend
\end{tikzpicture}
\caption{2D Temporal: GPU comparison}
\label{fig:Performance-GPU-2D-time}
\end{figure}